...
const KnowledgeGraph_1 = require("./GoogleKnowledgeGraph/KnowledgeGraph");
const app = express();
...
app.get("/search/:query", (req, res) => {
    ...
    KnowledgeGraph_1.search(req.params.query, (data) => {
